...
public interface TvdbSeries {
	/**
	 * Returns a series records that contains all information known about a
	 * particular series id.
	 *
	 * <p>
	 * If a translation is not available null will be returned (such as for
	 * seriesName or overview). Also errors will include '"invalidLanguage":
	 * "Incomplete or no translation for the given language"'.
	 *
	 * @param id
	 *            ID of the series.
	 * @param language
	...
	/**
	 * @see <a href=
	 *      "https://api.thetvdb.com/swagger#!/Series/get_series_id_actors">/series/{id}/actors</a>
	 */
	 ...
	 * <p>
	 * If a translation is not available null will be returned (such as for
	 * episodeName or overview) and the associated language property will be ''.
	 * Also errors will include '"invalidLanguage": "Some translations were not
	 ...
	 * The response is a paginated array of episode records that have been filtered
	 ...
	 *            See
	 *            <a href="http://en.wikipedia.org/wiki/Content_negotiation">Content
	 *            negotiation</a>. Records are returned with the Episode name and
	 *            Overview in the desired language, if it exists. If there is no
	 *            translation for the given language, then the record is still
	 *            returned but with empty values for the translated fields.
	 * @param page
	 *            Page of results to fetch. Defaults to page 1 if not provided.
	 */
